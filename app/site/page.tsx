...
const page = () => {
    return (
        <>
            <section className="h-full w-full sm:pt-[300px] relative flex items-center justify-center flex-col ">
            ...
            <section className='flex justify-center items-center flex-col gap-4  sm:mt-[300px]'>
                <h2 className='text-4xl text-center'>Choose what fits you right</h2>
                <p className='text-muted-foreground text-center'>Our straightforward pricing plans are tailored to meet your needs. if {" you're"} not
